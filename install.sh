...
echo "Installing..."
PACKAGES="bash dhcpcd dosfstools e2fsprogs filesystem iproute2 iputils linux-lts neovim nftables openssh pacman pciutils procps-ng psmisc rsync sed sudo"
